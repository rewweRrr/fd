  ...
  return (
    ...
    >
      <Box gridColumn={{ md: titleGridColumn }} gridRow={{ md: titleGridRow }}>
        <Typography variant='body1' fontSize={36} fontWeight={700} textTransform='uppercase' textAlign={titleTextAlign}>
          {title}
        </Typography>
      </Box>
      <Box
        ...
        sx={{ backgroundImage, backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'center' }}
      />
